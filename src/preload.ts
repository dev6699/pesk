...
const api: PeskApi = {
  ...
  readCodexProject: invokeChannel("read-codex-project"),
  createCodexProject: invokeChannel("create-codex-project"),
  importCodexProject: invokeChannel("import-codex-project"),
  updateCodexProject: invokeChannel("update-codex-project"),
  moveCodexProject: invokeChannel("move-codex-project"),
  ...
  getCodexAppServerProfiles: invokeChannel("get-codex-app-server-profiles"),
  addCodexAppServerProfile: invokeChannel("add-codex-app-server-profile"),
  updateCodexAppServerProfile: invokeChannel("update-codex-app-server-profile"),
  deleteCodexAppServerProfile: invokeChannel("delete-codex-app-server-profile"),
  selectCodexAppServerProfile: invokeChannel("select-codex-app-server-profile"),
